...
class RTCClient(
    ...
    private val iceServer = listOf(
        ...
        PeerConnection.IceServer.builder("turn:a.relay.metered.ca:80")
            .setUsername("db3dd86265b273266a06f088")
            .setPassword("3gINJg1s8AbsCFMA")
            .createIceServer()
    )
            ...
            .get().addOnSuccessListener {
                ...
                for ( dataSnapshot in it) {
                    if (dataSnapshot.contains("type") && dataSnapshot["type"]=="offerCandidate") {
                        ...
                        iceCandidateArray.add(IceCandidate(offerCandidate["sdpMid"].toString(),
                            Math.toIntExact(offerCandidate["sdpMLineIndex"] as Long), offerCandidate["sdp"].toString()))
                    } else if (dataSnapshot.contains("type") && dataSnapshot["type"]=="answerCandidate") {
                        val answerCandidate = dataSnapshot
                        iceCandidateArray.add(IceCandidate(answerCandidate["sdpMid"].toString(),
